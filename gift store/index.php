...
<html>
   ...
   <body>
    ...
    <div class="slider fullscreen slider_adjust">
        <ul class="slides">
          <li>
            ...
            <div class="caption left-align">
              <h1 class="black-text"><b>Welcome To The GiftStore!</b></h1>
          ...
          <li>
            ...
            <div class="caption right-align">
              <h1 class="white-text"><b>Get Maximum Opportunities!</b></h1>
              <!-- <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5> -->
            </div>
          </li>
          <li>
            ...
            <div class="caption right-align">
              <h1 class="white-text" ><b>Get Quick Delivery!</b></h1>
              <!-- <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5> -->
            </div>
          </li>
        </ul>
      ...
      <br><br>
      <!--About-->
      <div class="about" style="padding-top:600px;">
      <h1>About US</h1>
    ...
    <p style="font-size:20px;">
    This is giftstore. Welcome to our store. Maximum opportunites are offered on our website. Kindly look at our collection and order maximum products from our site.Safe banking and product tracking is also our feature.This is giftstore. Welcome to our store.
    </p>
    ...
    <div class="row" style="margin-left: -1px; margin-top: 20px;">
      ...
      <div class="row" style="margin-top: -20px;">
         <footer class="page-footer black white-text">
            ...
            <div class="row center-align">
              <div class="col s12 m12 l12">
                <a href="#" class="link"> Developed By Hari Raja Prabhu</a>
              </div>
            </div>
             <div class="row center-align">
                <div class="col s12 m12 l12">
